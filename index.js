...
"use strict";
/* unused harmony export initDB */
/* unused harmony export write */
/* unused harmony export get */
/* unused harmony export collection */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dexie__ = __webpack_require__(6);
...
var write = function write(collectionName, data) {
  console.log("DEXIE", collectionName, data);
  return new Promise(function (resolve, reject) {
    db.transaction("rw", db[collectionName],
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return db[collectionName].where({
                id: data.id
              }).count();
            ...
            case 9:
              db[collectionName].update(data.id, _objectSpread({}, data)).then(function (response) {
...
var get = function get(collectionName, id) {
  return new Promise(function (resolve, reject) {
    db[collectionName].get(id, function (info) {
      resolve(info);
    });
  });
};
...
var uuidv3 = __webpack_require__(13);

var Helper = {
  checkActionValidator: function checkActionValidator(action) {
    return !action.type.toString().startsWith("@@redux") && __WEBPACK_IMPORTED_MODULE_0__Config__["b" /* Config */].blackList.indexOf(action.type) < 0;
  },
  checkIsValidUUID: function checkIsValidUUID(str) {
    var regex = /^[0-9A-F]{8}-[0-9A-F]{4}-[3][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i;
    return regex.exec(str) !== null;
  },
  getUUID: function getUUID(key) {
    var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : uuidv3.DNS;
    return uuidv3(key, type);
  },
  storeNewStateToDB: function storeNewStateToDB(key, data) {
    __WEBPACK_IMPORTED_MODULE_1__db__["a" /* default */].write(__WEBPACK_IMPORTED_MODULE_0__Config__["b" /* Config */].collectionName, _objectSpread({
      id: key
    }, data));
  },
  getDataWithKeyFromDB: function getDataWithKeyFromDB(key) {
    return new Promise(function (resolve, reject) {
      __WEBPACK_IMPORTED_MODULE_1__db__["a" /* default */].get(__WEBPACK_IMPORTED_MODULE_0__Config__["b" /* Config */].collectionName, key).then(function (result) {
        resolve(result.data);
      })["catch"](function (err) {});
    });
  },
...
var TransformComponent = function TransformComponent(importComponent) {
  var _temp;
    ...
    _createClass(_temp, [{
      ...
      value: function render() {
        var _this$state = this.state,
            isFinishedTransform = _this$state.isFinishedTransform,
            Component = _this$state.Component,
            props = _this$state.props;
        return Component && isFinishedTransform ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Component, props) : null;
      }
    }]);

    return _temp;
  }(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component), _temp;
};

/* harmony default export */ __webpack_exports__["a"] = (TransformComponent);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "customStore", function() { return customStore; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__HocComponent__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Config__ = __webpack_require__(0);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
var updateImmutableState = function updateImmutableState(state, action) {
  if (__WEBPACK_IMPORTED_MODULE_1__Helper__["a" /* default */].checkActionValidator(action)) {
    if (action.dontStoreInDB) {
      return;
    }

    var objectsOfAction = Object.keys(action);
    var generateKey = __WEBPACK_IMPORTED_MODULE_1__Helper__["a" /* default */].getUUID(action.type);
    var finalObject = {
      actionType: action.type
    };
    objectsOfAction.map(function (key, index) {
      if (key !== "type") {
        finalObject[key] = {
          data: action[key]
        };
...
var customStore = function customStore(reducer) {
  return function (state, action) {
    var nextState = updateImmutableState(state, action);
    return reducer(nextState, action);
  };
};
var runService = function runService(store) {
  __WEBPACK_IMPORTED_MODULE_0__db__["a" /* default */].initDB().then(function () {
    __WEBPACK_IMPORTED_MODULE_0__db__["a" /* default */].collection(__WEBPACK_IMPORTED_MODULE_3__Config__["a" /* default */].collectionName).each(function (item) {
      var objects = Object.keys(item);
      var parameters = {};
      objects.map(function (key, index) {
...
var TransformComponent = __WEBPACK_IMPORTED_MODULE_2__HocComponent__["a" /* default */];
...
var v35 = __webpack_require__(12);
